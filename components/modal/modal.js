import settings from '../../base/js/settings';
import mixin from '../../base/js/misc/mixin';
import createComponent from '../../base/js/mixins/create-component';
import initComponentByLauncher from '../../base/js/mixins/init-component-by-launcher';
import eventedShowHideState from '../../base/js/mixins/evented-show-hide-state';
import handles from '../../base/js/mixins/handles';
import eventMatches from '../../base/js/misc/event-matches';
import on from '../../base/js/misc/on';
